...
three_digits_set = {first + second*base + third*base*base for first in digits for second in digits for third in digits}
...
## Task 20
list_sum_zip = [sum(s) for s in zip([10, 25, 40], [1, 15, 20])]
...
base = 10
digits = set(range(10))
representation_dict = {first + second*base + third*base*base : [third, second, first] for first in digits for second in digits for third in digits} 
